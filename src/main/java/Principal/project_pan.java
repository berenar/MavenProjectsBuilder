...
public class project_pan extends JPanel {
    ...
    private Border jl_order_borther;
    ...
    public void project_pan() {
        ...
        this.jl_order_borther = BorderFactory.createLineBorder(Color.GRAY, 1);
    ...
    public void configurar_project_pan(int n) {
        ...
        jl_order.setBorder(jl_order_borther);
        jl_path.setBounds(x_inicial + jl_order_size + 10, y_inicial * n, jl_path_width, jl_path_height);
        jl_path.setBorder(fc_border);
        jb_fc.setBounds(x_inicial + jl_path_width + 10, y_inicial, jb_fc_width, jb_fc_height);
    }
